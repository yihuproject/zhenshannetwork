...
<style scoped>
	...
	.bulletin_board .bulletin_board_arr{
		width: 100rem;
		height: 2.08rem;
		margin: 0 auto;
	}
	.bulletin_board .bulletin_board_arr>.navigator:first-child{
			min-width:5rem;
			width: 5rem;
			margin-right: 0;
		}
	.bulletin_board .bulletin_board_arr>.navigator{
		min-width:28rem;
		height: 4.16rem;
		color:#666666;
		font-size: 14px;
	...
	.bulletin_board .bulletin_board_arr>.navigator i:before{
		...
		height: 9px;
		content: "";
		background: url(/static/images/icon_sanjiao.png) no-repeat top left;
		position: absolute;
		top: 1.65rem;
		left: -1.5rem;
	}
	.bulletin_board .bulletin_board_arr>.navigator>i{
		height: 4.16rem;
		line-height: 4.16rem;
		color:#666666;
		font-size: 14px;
